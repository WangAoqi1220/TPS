...
PyObject* NePyWorld_FindObject(FNePyObjectBase* InSelf, PyObject* InArgs)
{
	if (!NePyBase::CheckValidAndSetPyErr(InSelf, "Self"))
	{
		return nullptr;
	...
	UObject* Object = FindObject<UObject>(World->GetOutermost(), UTF8_TO_TCHAR(Name));
	if (!Object)
	{
...
{"GetAllObjects", NePyCFunctionCast(&NePyWorld_GetAllObjects), METH_NOARGS, "(self) -> typing.List[Object]"}, \
{"GetAllActors", NePyCFunctionCast(&NePyWorld_GetAllActors), METH_NOARGS, "(self) -> typing.List[Actor]"}, \
{"FindObject", NePyCFunctionCast(&NePyWorld_FindObject), METH_VARARGS, "(self, Name: str) -> Object"}, \
{"GetLevels", NePyCFunctionCast(&NePyWorld_GetLevels), METH_NOARGS, "(self) -> typing.List[Level]"}, \
...
{"SpawnActor", NePyCFunctionCast(&NePyWorld_SpawnActor), METH_VARARGS, "(self, ActorClass: Class, Location: Vector = ..., Rotation: Rotator = ..., SpawnCollisionHandlingOverride: ESpawnActorCollisionHandlingMethod = ..., Name: str = ..., NameMode: int = ...) -> Actor"}, \
{"SpawnActorAbsolute", NePyCFunctionCast(&NePyWorld_SpawnActorAbsolute), METH_VARARGS, "(self, ActorClass: Class, AbsoluteTransform: Transform, SpawnCollisionHandlingOverride: ESpawnActorCollisionHandlingMethod = ..., Name: str = ..., NameMode: int = ...) -> Actor"}, \
